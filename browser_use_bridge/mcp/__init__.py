...
CURRENT_STATE_URI = "browser-use-bridge://state/current"


class BrowserUseServer:
    """Line-delimited stdio MCP server for browser-use-bridge automation tools."""
    ...
    def _initialize_result(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "serverInfo": {"name": "browser-use-bridge", "version": "0.8.0"},
            "capabilities": {
